<template>
  <main>
    ...
    <h2 class="dark:text-white mt-5 text-center text-2xl font-semibold text-black">Notre festival</h2>
    <p class="dark:text-white mt-3 ml-3 mr-2 text-left text-sm text-black">
    ...
    <p class="dark:text-white mt-3 ml-3 mb-12 mr-2 text-left text-sm text-black">
