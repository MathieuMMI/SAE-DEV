<template>
  <main>
    ...
    <div class="flex flex-col gap-5 mb-[100%]">
      ...
      <input class="m-auto w-[40%] rounded-[200px] border border-amber-600 bg-white" type="text" placeholder="Email" />
      <input class="m-auto w-[40%] rounded-[200px] border border-amber-600 bg-white" type="text" placeholder="Téléphone (optionnel)" />
      <input class="m-auto w-[40%] h-56 rounded-[50px] bg-white border border-amber-600" type="text" placeholder="Message" />
    </div>
  </main>
</template>
